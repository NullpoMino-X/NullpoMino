...
public class NumericMenuItem extends MenuItem {
    ...
    static final int ARITHSTYLE_MODULAR = 0;
    private static final int ARITHSTYLE_SATURATE = 1;
    ...
    NumericMenuItem(String name, int color, int state, int minValue, int maxValue, int step, int arithmeticStyle) {
        super(name);
        this.color = color;
        this.state = state;
